...
![JCF](http://leocook-blog.test.upcdn.net/JCF.gif)
...
![List](http://leocook-blog.test.upcdn.net/list.png)
...
![Queue](http://leocook-blog.test.upcdn.net/Queue.png)
...
![Map](http://leocook-blog.test.upcdn.net/map.png)
...
![map结构](http://leocook-blog.test.upcdn.net/map%20struct.png)
...
![JCF接口架构](http://leocook-blog.test.upcdn.net/JCF.gif)

- 常用的集合分类情况

![常用的集合分类情况](http://leocook-blog.test.upcdn.net/jcf%E4%BD%BF%E7%94%A8.png)

- 接口功能实现

下面表格描述的比较好，每个接口对应不同数据结构的实现。

![JCF 接口实现](http://leocook-blog.test.upcdn.net/jcf%20imp.png)
